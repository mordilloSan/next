...
const CreateInterfaceDialog = ({ open, onClose, onCreate, loading, error, name, setName, port, setPort, serverAddress, setServerAddress, peers, setPeers}) => {
  return (
    <Dialog open={open} onClose={onClose} fullWidth maxWidth="sm">
      <DialogTitle>Create New Interface</DialogTitle>
      <DialogContent>
        <Box mt={2}>
          <TextField label="Interface Name" value={name} onChange={(e) => setName(e.target.value)} fullWidth margin="normal" />
